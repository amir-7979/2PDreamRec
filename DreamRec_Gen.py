...
class TuningMetric:
    ...
    def __init__(self, name, values):
        ...
        # For each candidate, use a dict: key = evaluation epoch, value = list of HR@10 values
...
############################################
# Main Function with If-Else for Tuning vs. Normal 10-Fold CV
############################################
def main():
    NUM_FOLDS = 10
    if args.tune:
